...
ACTION_TEMPLATES: Final[dict[str, tuple[str, ...]]] = {
    ...
    "закопать": (
        "{actor} закопал {target_acc}",
        "{actor} зарыл {target_acc}",
    ),
    "убить": (
        "{actor} убил {target_acc}",
        "{actor} ликвидировал {target_acc}",
    ),
    "съесть": (
    ...
    "депортировать": (
        "{actor} депортировал {target_acc}",
        "{actor} выслал {target_acc} за границу",
    ),
    ...
    "отомстить": (
        "{actor} отомстил {target_dat}",
        "{actor} расквитался с {target_ablt}",
    ),
    "предать": (
    ...
    "осудить": (
        "{actor} осудил {target_acc}",
        "{actor} вынес приговор {target_dat}",
    ),
    "вызвать полицию": (
